                ...
                <div class="row" bis_skin_checked="1">
                    <div class="col-md-8">
                        <div class="d-flex flex-wrap align-items-center gap-3">
                            <!-- Search Form -->
                            <form method="GET" action="{{ route('admin.coupons.index') }}" id="searchForm" class="d-flex">
                            ...
                            <div class="quick-actions">
                                ...
                                <button type="button" class="btn btn-outline-warning btn-sm"
                                    onclick="applyFilter('type', 'percentage')">
                                    <i class="fas fa-percentage"></i> نسبة مئوية
                                </button>
                                <button type="button" class="btn btn-outline-info btn-sm"
                                    onclick="applyFilter('type', 'fixed')">
                        ...
                        <div class="row" bis_skin_checked="1">
                            <div class="col-md-3" bis_skin_checked="1">
                                <div class="filter-section" bis_skin_checked="1">
                                    ...
                                    <div class="row g-2" bis_skin_checked="1">
                                        <div class="col-6" bis_skin_checked="1">
                                            <input type="date" class="form-control" name="starts_from"
                                                id="startsFrom">
                                        </div>
                                        <div class="col-6" bis_skin_checked="1">
                            ...
                            <div class="col-md-3" bis_skin_checked="1">
                                <div class="filter-section" bis_skin_checked="1">
                                    ...
                                    <div class="row g-2" bis_skin_checked="1">
                                        <div class="col-6" bis_skin_checked="1">
                                            <input type="date" class="form-control" name="expires_from"
                                                id="expiresFrom">
                                        </div>
                                        <div class="col-6" bis_skin_checked="1">
                            ...
                            <div class="coupon-card" data-coupon-id="{{ $coupon->id }}">
                                <div class="coupon-header">
                                    ...
                                    <div class="coupon-type">
                                        {{ $coupon->type === 'percentage' ? 'نسبة مئوية' : 'مبلغ ثابت' }}</div>
                                </div>
