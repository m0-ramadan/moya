                    ...
                    <div class="card-body" bis_skin_checked="1">
                        <form id="couponForm" method="POST" action="{{ route('admin.coupons.store') }}">
                            ...
                            <div class="row" bis_skin_checked="1">
                                ...
                                <div class="col-md-6 mb-3" bis_skin_checked="1">
                                    ...
                                    <div class="input-group" bis_skin_checked="1">
                                        <input type="text" class="form-control" id="code" name="code"
                                            value="{{ old('code') }}" required placeholder="مثال: SUMMER2026">
                                ...
                                <div class="col-md-6 mb-3" bis_skin_checked="1">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                        value="{{ old('name') }}" required placeholder="مثال: خصم الصيف 2024">
                                </div>
                            </div>
                            ...
                            <div class="mb-3" bis_skin_checked="1">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="3" placeholder="وصف قصير للكوبون...">{{ old('description') }}</textarea>
                            </div>
                            ...
                            <div class="row" bis_skin_checked="1">
                                ...
                                <div class="col-md-6 mb-3" bis_skin_checked="1">
                                    ...
                                    <div class="btn-group w-100" role="group" aria-label="نوع الكوبون"
                                        bis_skin_checked="1">
                            ...
                            <div class="mb-3" bis_skin_checked="1">
                                ...
                                <div class="input-group" bis_skin_checked="1">
                                    <input type="number" class="form-control" id="min_order_amount"
                                        name="min_order_amount" value="{{ old('min_order_amount') }}" step="0.01"
                            ...
                            <div class="row" bis_skin_checked="1">
                                ...
                                <div class="col-md-6 mb-3" bis_skin_checked="1">
                                    ...
                                    <input type="number" class="form-control" id="max_uses_per_user"
                                        name="max_uses_per_user" value="{{ old('max_uses_per_user') }}" min="1"
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.valid) {
                            ...
                            $('#codeFeedback').text('').removeClass('invalid-feedback').addClass(
                                'valid-feedback');
