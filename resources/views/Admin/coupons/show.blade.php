                ...
                <div class="card mb-4" bis_skin_checked="1">
                    ...
                    <div class="card-body" bis_skin_checked="1">
                        <div class="row" bis_skin_checked="1">
                            ...
                            <div class="col-md-3 col-sm-6 mb-3" bis_skin_checked="1">
                                <div class="stats-card" bis_skin_checked="1">
                                    <div class="stats-number" bis_skin_checked="1">{{ $usageStatistics['this_week'] }}
                                    </div>
                            ...
                            <div class="col-md-3 col-sm-6 mb-3" bis_skin_checked="1">
                                <div class="stats-card" bis_skin_checked="1">
                                    <div class="stats-number" bis_skin_checked="1">{{ $usageStatistics['this_month'] }}
                                    </div>
                        ...
                        @if ($coupon->max_uses)
                            <div class="mb-4" bis_skin_checked="1">
                                <div class="d-flex justify-content-between mb-2" bis_skin_checked="1">
                                    ...
                                    <span
                                        class="fw-bold">{{ round(($coupon->usages()->count() / $coupon->max_uses) * 100) }}%</span>
                                </div>
                                ...
                                <div class="d-flex justify-content-between mt-2" bis_skin_checked="1">
                                    <small class="text-muted">تم استخدام {{ $coupon->usages()->count() }} من
                                        {{ $coupon->max_uses }}</small>
                                </div>
                            </div>
                        @endif
                    ...
                    <div class="card-body" bis_skin_checked="1">
                        <div class="d-grid gap-2" bis_skin_checked="1">
                            ...
                            <button type="button" class="btn btn-outline-primary w-100"
                                onclick="sendToEmail('{{ $coupon->code }}')">
                                                ...
                                                @if ($usage->user)
                                                    ...
                                                    <div bis_skin_checked="1">
                                                        <div class="fw-semibold" bis_skin_checked="1">
                                                            {{ $usage->user->name }}</div>
                                                        <small
                                                            class="text-muted">{{ $usage->created_at->diffForHumans() }}</small>
                                                    </div>
                                                @else
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($usage->order)
                                            ...
                                            <br>
                                            <small class="text-muted">{{ number_format($usage->order->total, 2) }}
                                                ر.س</small>
                                        @else
                                    ...
                                    <td>
                                        <small
                                            class="text-muted">{{ $usage->session_id ? substr($usage->session_id, 0, 8) . '...' : '-' }}</small>
                                    </td>
                                    <td>
                                        <div bis_skin_checked="1">
                                            <div class="fw-semibold" bis_skin_checked="1">
                                                {{ $usage->created_at->format('Y/m/d') }}</div>
        ...
        window.exportUsageHistory = function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.open(
                        '{{ route('admin.coupons.export') }}?type=excel&coupon_id={{ $coupon->id }}',
                        '_blank');
                }
            });
        }
