...
@section('title', 'إرسال إشعار للسائقين')
...
<div class="card">
    <div class="card-header pb-0">
        <h5>إرسال إشعار لجميع السائقين</h5>
    </div>
    <div class="card-body">
        <form class="form theme-form" action="{{ route('admin.representatives.sendnotification', 0) }}" method="post">
            @csrf
            <div class="row">
                <div class="col-12">
