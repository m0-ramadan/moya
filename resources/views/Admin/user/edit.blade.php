...
<div class="card">
  ...
  <form class="form theme-form" action="{{route('admin.user.update')}}" method="post" enctype="multipart/form-data">
      @if ($errors->any())
  ...
  <div class="row g-3  mb-3">
                  ...
                  <div class="row g-3 mb-3">
                    <div class="col-md-8 m-2">
                      ...
                      <input class="form-control @error('image') is-invalid fparsley-error parsley-error @enderror" name="phone" id="exampleInputPassword2" type="text" placeholder="phone" value="{{old('phone',$user->phone ?? '')}}">
                      @error('phone')
                      <span class="invalid-feedback text-black font-weight-bold text-capitalize mt-2" role="alert">
                        <p>{{ $message }}</p>
                      </span>
                  ...
                  <div class="row g-3 mb-3">
                    <div class="col-md-8 m-2">
                      ...
                      <input class="form-control @error('image') is-invalid fparsley-error parsley-error @enderror" name="phone2" id="exampleInputPassword2" type="text" placeholder="phone2" value="{{old('phone2',$user->phone2 ?? '')}}">
                      @error('phone2')
                      <span class="invalid-feedback text-black font-weight-bold text-capitalize mt-2" role="alert">
                        <p>{{ $message }}</p>
                      </span>
