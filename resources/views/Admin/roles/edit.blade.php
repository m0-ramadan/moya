                                ...
                                <div class="mb-4" bis_skin_checked="1">
                                    ...
                                    <div class="form-group" bis_skin_checked="1">
                                        ...
                                        <div class="form-text" bis_skin_checked="1">
                                            لا يمكن تعديل اسم الرتبة الأساسي (باللغة الإنجليزية).
                                        </div>
                                        @error('name')
                                                            ...
                                                            <div class="col-md-6 mb-2" bis_skin_checked="1">
                                                                <div class="permission-item" bis_skin_checked="1">
                                                                    <input type="checkbox" name="permissions[]"
                                                                        ...
                                                                        data-module="{{ $module }}"
                                                                        @if (in_array($permission->id, old('permissions', $selectedPermissions))) checked @endif>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            // استرجاع البيانات عند إعادة تحميل الصفحة أو تحميلها لأول مرة
            const savedPermissions = {!! json_encode(old('permissions', $selectedPermissions)) !!};
